      ...
      <SectionContainer>
        <div className="w-full flex flex-col justify-center items-center py-12">
          <div className="flex justify-center items-center mb-4">
            ...
            <a href="https://api.whatsapp.com/send?phone=447495282510" target="_blank"><img className="w-10 h-10" src="/assets/icons/whatsapp-icon.svg" alt="WhatsApp icon" aria-label="WhatsApp link" /></a>
          </div>
          <p className="">© {currentYear} - MJB BUILDERS LTD</p>
        </div>
      </SectionContainer>
    </footer>
  )
